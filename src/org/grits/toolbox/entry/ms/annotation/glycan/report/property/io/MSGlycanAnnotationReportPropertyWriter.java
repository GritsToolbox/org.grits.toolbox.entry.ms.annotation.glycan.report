...
public class MSGlycanAnnotationReportPropertyWriter implements PropertyWriter
{
	@Override
	public void write(Property property, Element propertyElement) throws IOException {
		if(property instanceof MSGlycanAnnotationReportProperty) {
			MSGlycanAnnotationReportProperty msProperty = (MSGlycanAnnotationReportProperty) property;
			...
			throw new IOException("This property is not a MS Glycan Annotation Report Property");
		}
	}
}
