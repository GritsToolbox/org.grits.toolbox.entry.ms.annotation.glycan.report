 ...
 *
 */
public class ViewMSGlycanAnnotationResultsFromMerge {
	
	//log4J Logger
	private static final Logger logger = Logger.getLogger(ViewMSGlycanAnnotationResultsFromMerge.class);

//	public final static String VIEW_ID = "plugin.ms.annotation.glycan.views.MSGlycanAnnotationMultiPageViewer";
	
	public static final String PARAMETER_ID = "viewAnnotationResultsFromMerge_Entry";
	public static final String COMMAND_ID = "org.grits.toolbox.entry.ms.handler.viewMSGlycanAnnotationResultsFromMerge";
	...
	public boolean canExecute(@Named(IServiceConstants.ACTIVE_SELECTION) Object object, @Named(IServiceConstants.ACTIVE_PART) MPart part) {
        ...
        if (entry != null) {
        	if ( entry.getProperty().getType().equals( MSGlycanAnnotationReportProperty.TYPE )  ||
        			entry.getProperty() instanceof MSGlycanAnnotationReportProperty) 
            	return true;
        }
